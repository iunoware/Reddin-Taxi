      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-x-12 md:gap-y-16">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group shadow-[3px_3px_10px_#8d8d8d,-3px_-3px_10px_#ffffff] flex flex-col md:flex-row items-start gap-5 p-6 rounded-xl overflow-hidden hover:border-red-500/30 transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_10px_40px_-10px_rgba(0,0,0,0.5)]"
            >
              {/* Icon Side */}
