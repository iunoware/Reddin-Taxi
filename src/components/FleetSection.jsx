        ...
        <div className="flex flex-col lg:flex-col gap-16">
          ...
          <div className="w-full flex flex-col items-center justify-center space-y-10 sticky top-24 h-fit">
            <div className="space-y-6 flex flex-col items-center justify-center">
              <h4 className="text-white tracking-[0.2em] text-sm font-bold uppercase">
                The Collection
              </h4>
              <h2 className="text-5xl md:text-6xl font-bold cinzel leading-tight">
                Our Luxury
                <span className="text-transparent bg-clip-text bg-linear-to-r from-red-200 via-red-400 to-red-600">
                  {" "}
                  Fleet
                </span>
              </h2>
          ...
          <div className="w-full pt-15 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {vans.map((item, index) => (
              <div
                key={index}
                className="group relative bg-white/5 backdrop-blur-md shadow-[0_8px_24px_rgba(0,0,0,0.15),inset_0_0.5px_5px_rgba(255,255,255,0.4)] rounded-xl overflow-hidden hover:border-yellow-500/30 transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_10px_40px_-10px_rgba(0,0,0,0.5)]"
              >
                {/* Image Container */}
